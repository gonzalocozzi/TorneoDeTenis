...
{
    public class EnfrentamientoMasculinoStrategyTests
    {
        private readonly Mock<IRandomProvider> _randomProviderMock;
        private readonly EnfrentamientoMasculinoStrategy _strategy;

        public EnfrentamientoMasculinoStrategyTests()
        {
            _randomProviderMock = new Mock<IRandomProvider>();
            _strategy = new EnfrentamientoMasculinoStrategy(_randomProviderMock.Object);
        }
